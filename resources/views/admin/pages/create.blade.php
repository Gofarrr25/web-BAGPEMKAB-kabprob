                ...
                <div id="tab-konten" class="tab-pane space-y-6">
                    <div>
                        ...
                        <div class="mt-2 flex items-center gap-2 text-xs font-mono text-gray-500 bg-gray-50 px-3 py-1.5 rounded-lg border border-gray-200">
                            ...
                            <span id="permalink_preview" class="text-blue-700 font-bold">{{ url('/page/judul-halaman') }}</span>
                        </div>
                    </div>
                        ...
                        <div class="border border-gray-200 rounded-2xl p-5 bg-gray-50/50 space-y-4">
                            ...
                            <div class="drag-drop-box border-2 border-dashed border-gray-300 hover:border-emerald-500 rounded-xl p-6 text-center bg-white cursor-pointer" onclick="document.getElementById('image_file_input').click()" id="image_drop_zone">
                                ...
                                <div id="image_preview_container" class="hidden space-y-3 relative mx-auto w-full max-w-sm aspect-[16/9] overflow-hidden rounded-lg border border-gray-200">
                                    <img id="image_preview_img" class="w-full h-full object-cover">
                ...
                <div id="tab-seo" class="tab-pane hidden space-y-6">
                    <div class="border border-gray-200 rounded-2xl p-6 bg-gray-50/50 space-y-5">
                        ...
                        <div class="bg-white p-4 rounded-xl border border-gray-200 space-y-1 shadow-sm">
                            ...
                            <div class="text-xs text-emerald-700 font-mono truncate" id="google_url_preview">{{ url('/page/judul-halaman') }}</div>
                            <div class="text-base font-bold text-blue-800 hover:underline cursor-pointer truncate" id="google_title_preview">
                                Judul Halaman Publikasi
                            </div>
                            <div class="text-xs text-gray-600 line-clamp-2" id="google_desc_preview">
                                Ringkasan halaman ini akan muncul pada hasil pencarian Google.
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="seo_title" id="seo_title_input" value="{{ old('seo_title') }}" oninput="updateSeoPreview()" placeholder="Judul khusus untuk Google..." class="w-full px-4 py-2.5 border border-gray-300 rounded-xl outline-none text-xs bg-white font-semibold">
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="seo_description" id="seo_desc_input" rows="3" oninput="updateSeoPreview()" placeholder="Ringkasan halaman untuk mesin pencari..." class="w-full px-4 py-2.5 border border-gray-300 rounded-xl outline-none text-xs bg-white">{{ old('seo_description') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function updatePermalinkPreview(title) {
        ...
        if (!document.getElementById('seo_title_input').value) {
            document.getElementById('google_title_preview').innerText = title || 'Judul Halaman Publikasi';
        }
    }
    ...
    function updateSeoPreview() {
        ...
        document.getElementById('google_title_preview').innerText = titleInput.value || (document.getElementById('page_title_input').value || 'Judul Halaman Publikasi');
