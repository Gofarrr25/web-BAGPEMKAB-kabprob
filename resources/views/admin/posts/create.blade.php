...
@section('title', 'Tulis Berita - Admin Panel')
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 max-w-5xl">
    <div class="px-4 md:px-6 py-4 border-b border-gray-100 bg-gray-50/50 flex flex-wrap gap-3 justify-between items-center">
        <h3 class="font-bold text-gray-800">Form Editor Berita & Informasi</h3>
        ...
        <span class="text-xs bg-brand-blue-light text-brand-blue px-3 py-1 rounded-full font-bold">WYSIWYG Editor Professional</span>
    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div>
                        ...
                        <input type="text" name="title" required value="{{ old('title') }}" placeholder="Masukkan judul yang menarik..."
                    ...
                    <div>
                        ...
                        <!-- CKEditor 5 Textarea -->
                        <textarea name="content" id="ck-editor" class="w-full border border-gray-300 rounded-lg">{{ old('content') }}</textarea>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                        ...
                        <p class="text-xs text-gray-500 mt-1">Biarkan default untuk menggunakan waktu saat ini.</p>
                    ...
                    <!-- Album Foto -->
                    <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                        <label class="block text-sm font-bold text-gray-700 mb-2">Album Foto Berita (Opsional)</label>
                    ...
                    <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                        ...
                        <label class="inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="is_published" value="1" checked class="w-4 h-4 text-brand-blue rounded focus:ring-brand-blue">
                    ...
                    <div class="pt-4 flex flex-col gap-3">
                        <button type="submit" class="w-full py-3 bg-brand-blue text-white font-bold rounded-lg hover:bg-brand-blue-hover transition shadow-md text-sm flex items-center justify-center gap-2">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        createCkEditor('#ck-editor', 'Tuliskan isi berita, tabel, embed YouTube, atau unggah foto/PDF/Word/Excel/ZIP di sini...');
    });
