...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 max-w-5xl">
    <div class="px-6 py-4 border-b border-gray-100 bg-gray-50/50 flex justify-between items-center">
        ...
        <span class="text-xs bg-blue-100 text-blue-800 px-3 py-1 rounded-full font-bold">WYSIWYG Editor Professional</span>
    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                        ...
                        <label class="inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="is_published" value="1" checked class="w-4 h-4 text-blue-600 rounded focus:ring-blue-500">
                    ...
                    <div class="pt-4 flex flex-col gap-3">
                        <button type="submit" class="w-full py-3 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 transition shadow-md text-sm flex items-center justify-center gap-2">
